        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    B1 = table.Column<string>(type: "TEXT", nullable: true),
                    C1 = table.Column<string>(type: "TEXT", nullable: true),
                    D1 = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    B2 = table.Column<string>(type: "TEXT", nullable: true),
                    C2 = table.Column<string>(type: "TEXT", nullable: true),
                    D2 = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    B3 = table.Column<string>(type: "TEXT", nullable: true),
                    C3 = table.Column<string>(type: "TEXT", nullable: true),
                    D3 = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    B4 = table.Column<string>(type: "TEXT", nullable: true),
                    C4 = table.Column<string>(type: "TEXT", nullable: true),
                    D4 = table.Column<string>(type: "TEXT", nullable: true),
                    Answer4 = table.Column<string>(type: "TEXT", nullable: true),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedDate = table.Column<string>(type: "TEXT", nullable: false, defaultValueSql: "getdate()")
                },
                constraints: table =>
                {
